            ...
            <div class="col-lg-6">
                <div class="about__content">
                    <div class="section__title">
                        ...
                        <h2 class="title">{{ $aboutPageData->title }}</h2>
                    </div>
                    <div class="about__exp">
                        ...
                        <div class="about__exp__content">
                            <p>{{ $aboutPageData->short_title }}</p>
                        </div>
                    </div>
                    <p class="desc">{{ $aboutPageData->short_description }}</p>
                    <a href="{{ route('about_page.index') }}" class="btn">Download my resume</a>
                </div>
            </div>
        </div>
    </div>
