                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ Route::currentRouteNamed('portfolio.create') ? route('portfolio.store') : route('portfolio.update',$portfolio) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                  <label for="example-text-input" class="col-sm-2 col-form-label">@lang('general.portfolio_name')</label>
                                  <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">@lang('general.portfolio_title') </label>
                                 <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                  <label for="example-text-input" class="col-sm-2 col-form-label">@lang('general.portfolio_image')</label>
                                  <div class="col-sm-10">
