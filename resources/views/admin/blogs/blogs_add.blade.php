                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ Route::currentRouteNamed('blog.create') ? route('blog.store') : route('blog.update',$blog) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">@lang('general.blog_title')</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">@lang('general.blog_tags')</label>
                                <div class="col-sm-10">
                                    <input name="tags" value="{{ old('tags') ?? (isset($blog) ? $blog->tags : '')  }}" class="form-control" type="text" data-role="tagsinput">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">@lang('general.blog_description')</label>
                                <div class="col-sm-10">
                                    <textarea id="elm1" name="description">{{ old('description') ?? (isset($blog) ? $blog->description : '')  }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">@lang('general.blog_image')</label>
                                <div class="col-sm-10">
