     ...
     <div data-simplebar class="h-100">
         <div id="sidebar-menu">
             <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('home_slider.index') }}" class="has-arrow ">
                ...
                <li>
                    <a href="{{ route('blog.index') }}" class="has-arrow">
                        <i class="ri-profile-line"></i>
                        <span>Blog Page</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('footer.index') }}" class="has-arrow">
                        <i class="ri-profile-line"></i>
                        <span>Footer Page Setup</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('contact.index') }}" class="has-arrow">
                        <i class="ri-profile-line"></i>
