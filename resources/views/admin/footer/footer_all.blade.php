    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">@lang('general.footer_page')</h4>
                        <form method="post" action="{{ route('footer.update', $footer) }}" >
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">@lang('general.number')</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">@lang('general.address')</label>
                                <div class="col-sm-10">
                                    <input name="address" class="form-control" type="text" value="{{ $footer->address }}"  id="example-text-input">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">@lang('general.email')</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                  <label for="example-text-input" class="col-sm-2 col-form-label">@lang('general.copyright')</label>
                                  <div class="col-sm-10">
